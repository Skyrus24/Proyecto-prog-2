...
public class FrmModificarCitas extends javax.swing.JDialog {
    ...
    private void cargarDatosCita(int idCita) {
        try (Connection cn = bd.miConexion()) {
            ...
            if (rs.next()) {
                ...
                cboInicioHora.addItem(horaInicio.toString());
            ...
            JOptionPane.showMessageDialog(this, "Error al cargar la cita: " + ex.getMessage(), "Error SQL", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        // Si el usuario seleccionó una cita
        int idCitaSeleccionada = buscador.getIdCitaSeleccionada();
        if (idCitaSeleccionada > 0) {
            cargarDatosCita(idCitaSeleccionada);
        }
