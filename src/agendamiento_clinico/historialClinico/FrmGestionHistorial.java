...
public class FrmGestionHistorial extends javax.swing.JDialog {

    private final BaseDatos bd = new BaseDatos();
    private final Grilla grilla = new Grilla();

    public FrmGestionHistorial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cmdModificar.setFont(new java.awt.Font("Segoe UI", 3, 17)); // NOI18N
        cmdModificar.setText("Modificar Historial");
        ...
        cmdEliminar.setFont(new java.awt.Font("Segoe UI", 3, 17)); // NOI18N
        cmdEliminar.setText("Eliminar Historial");
    ...
    private void cmdModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdModificarActionPerformed
        ...
        // Obtenemos el ID del historial de la primera columna (columna 0)
        int idHistorial = (int) grdHistoriales.getValueAt(filaSeleccionada, 0);

        // Creamos una instancia de FrmAtencionCita usando el NUEVO constructor que solo pide el ID
        FrmAtencionCitas frmModificar = new FrmAtencionCitas(null, true, idHistorial);
        frmModificar.setVisible(true);

        // Después de que la ventana de modificar se cierre, recargamos la lista de historiales
    ...
    private void cmdEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdEliminarActionPerformed
        // 1. Verificar que haya una fila seleccionada en la grilla
        int filaSeleccionada = grdHistoriales.getSelectedRow();
        ...
        // 2. Obtener el ID del historial que se va a eliminar
        String idHistorial = grdHistoriales.getValueAt(filaSeleccionada, 0).toString();
        
        // 3. Llamar a tu método centralizado.
        //    Este se encargará de preguntar al usuario y mostrar el resultado.
        boolean fueEliminado = bd.borrarRegistro("historial_clinico", "id_historial = " + idHistorial);
        
        // 4. Si el registro fue eliminado exitosamente, simplemente actualizamos la tabla.
        if (fueEliminado) {
            cargarHistoriales();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGestionHistorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmGestionHistorial dialog = new FrmGestionHistorial(new javax.swing.JFrame(), true);
